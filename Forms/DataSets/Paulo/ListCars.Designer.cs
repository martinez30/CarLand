...
SELECT idCar, Color, Board, Model, Fuel, Doors, Branch, Year FROM Car WHERE (idCar = @idCar)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1].CommandText = "SELECT idCar, Color, Board, Model, Fuel, Doors, Branch, Year FROM dbo.Car where A" +
                "vailable = 1";
        ...
        public virtual int FillBy(ListCars.CarDataTable dataTable) {
